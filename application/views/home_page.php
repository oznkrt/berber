...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?php echo base_url( 'assets/home/assets/img/logo/loder.png')?>" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="<?php echo base_url( 'assets/home/assets/img/logo/logo.png')?>" alt=""></a>
                            </div>
                        </div>
    ...
    <main>
        ...
        <section class="about-area section-padding30 position-relative">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-11">
                        <!-- about-img -->
                        <div class="about-img ">
                            <img src="<?php echo base_url( 'assets/home/img/gallery/about.png')?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <div class="section-tittle section-tittle3 mb-35">
								<?php foreach ($jobs['abouts'] as $about){ ?>
									<?php echo $about->aboutexplant?>
									<img src="<?php echo base_url('assets/home/img/gallery/signature.png')?>" alt="">
								<?php }?>
                        </div>
                    </div>
                </div>
            ...
            <div class="about-shape">
                <img src="<?php echo base_url( 'assets/home/img/gallery/about-shape.png')?>" alt="">
            </div>
        </section>
        <!-- About-2 Area End -->
        <!--? Services Area Start -->
        <section class="service-area pb-170">
            <div class="container">
                ...
                <!-- Section caption -->
                <div class="row">
					<?php foreach ($jobs['explants'] as $explant){?>
                ...
                <div class="row team-active dot-style">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="<?php echo base_url('uploads/').$job->images?>" alt="">
                            </div>
                            <div class="team-caption">
                                <span><?php echo $job->status?></span>
                                <h3><a href="#"><?php echo $job->jobsname ?></a></h3>
                            </div>
                        </div>
                    </div>
					<?php }?>
        ...
        <div class="best-pricing section-padding2 position-relative">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="pricing-list">
                                    <ul><?php foreach ($jobs['money'] as $make){ ?>
                                        <li><?php echo $make->make?>. . . . . . . . . . . . . . . . . . .  <span><?php echo $make->money?>TL</span></li>
            ...
            <div class="pricing-img">
                <img class="pricing-img1" src="<?php echo base_url('assets/home/img/gallery/pricing1.png')?>" alt="">
                <img class="pricing-img2" src="<?php echo base_url('assets/home/img/gallery/pricing2.png')?>" alt="">
            </div>
        </div>
		<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url('<?php echo base_url("assets/home/img/gallery/gallery1.png")?>');"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url('<?php echo base_url("assets/home/img/gallery/gallery2.png")?>');"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url('<?php echo base_url("assets/home/img/gallery/gallery3.png")?>');"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url('<?php echo base_url("assets/home/img/gallery/gallery4.png")?>');"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Gallery Area End -->
        <!-- Cut Details Start -->
        <div class="cut-details section-bg section-padding2" data-background="<?php echo base_url( 'assets/home/img/gallery/section_bg02.png')?>">
           <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo base_url( 'assets/home/img/gallery/home-blog1.png')?>" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo base_url( 'assets/home/img/gallery/home-blog2.png')?>" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
    ...
    <footer>
        <!--? Footer Start-->
        <div class="footer-area section-bg" data-background="<?php echo base_url( 'assets/home/img/gallery/footer_bg.png')?>">
            <div class="container">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="<?php echo base_url( 'assets/home/img/logo/logo2_footer.png')?>" alt=""></a>
                                </div>
