            ...
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
					<div class="embed-responsive embed-responsive-21by9">
						<iframe class="embed-responsive-item" src='<?php  echo $contacts->iframe ?>'></iframe>
					</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="<?php echo base_url('welcome/messages_add')?>" method="post" >
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3><?php echo $contact->country ?></h3>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p><?php echo $contact->phoneDate ?></p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p><?php echo $contact->emailtext ?></p>
                            </div>
                        </div>
